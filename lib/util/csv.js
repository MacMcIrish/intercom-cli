...
module.exports.writer = (fileName, headers) => {
...
module.exports.write = (fileName, data) => new Promise((resolve) => {
  const writer = this.writer(fileName, Object.keys(data[0]));
  data.forEach(entry => writer.append(entry));
